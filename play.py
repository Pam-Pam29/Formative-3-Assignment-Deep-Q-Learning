...
================================================
  ...
  Group Shared Script
  Loads group best model and plays
  Shows live game window AND records video
  Stable Baselines 3 + Gymnasium

  Group: Victoria Fakunle, Pretty Ntakirutimana, Erneste
  Best model: Victoria exp02 — Mean Reward 31.80
  Environment: ALE/Breakout-v5

  NOTE: Run locally on a laptop — requires a screen.
        Does NOT work on Colab or Kaggle.
================================================
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
MODEL_PATH = "./Best Model/dqn_model.zip"   # group best — Victoria exp02
...
print("  Model: Best_Model/dqn_model.zip")
...
if not os.path.exists(MODEL_PATH):
    ...
    print("  Make sure Best_Model/dqn_model.zip exists in the repo root.")
    exit(1)
